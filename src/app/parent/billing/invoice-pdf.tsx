...
interface ParentInvoicePDFProps {
...
export function ParentInvoicePDF({ billingInfo, lessons, yearMonth, teacherName, studentName, onClose }: ParentInvoicePDFProps) {
    ...
    const generatePrintHTML = () => {
        ...
        const adjustmentsHTML = billingInfo.adjustments.details.length > 0
            ? billingInfo.adjustments.details.map((detail) => `
                <tr style="border-bottom: 1px solid #eee;">
                    <td style="padding: 8px 4px; color: #111;">
        ...
        const otherChargesHTML = billingInfo.otherCharges && billingInfo.otherCharges.items.length > 0
            ? `
                <div>
                    ...
                    <table style="width: 100%; font-size: 14px; border-collapse: collapse;">
                        ...
                        <tbody>
                            ${billingInfo.otherCharges.items.map((item) => `
                                <tr style="border-bottom: 1px solid #eee;">
                                    <td style="padding: 8px 4px; color: #111;">
                        ...
                        <tfoot>
                            <tr style="border-top: 2px solid #ddd;">
                                ...
                                <td style="padding: 8px 4px; text-align: right; font-weight: bold; color: #111;">
                                    ${formatCurrency(billingInfo.otherCharges.total)}
                                </td>
                            </tr>
                        </tfoot>
                    </table>
        ...
        const hasOtherCharges = billingInfo.otherCharges && billingInfo.otherCharges.items.length > 0
        ...
        return `
            ...
            <head>
                <meta charset="UTF-8">
                <title>請求書 - ${studentName} - ${year}年${parseInt(month)}月</title>
                <style>
                    @page {
                        size: A4;
                        margin: 15mm;
                            ...
                            <tfoot>
                                <tr style="border-top: 2px solid #ddd;">
                                    <td colspan="4" style="padding: 8px 4px; text-align: right; font-weight: 500; color: #111;">
                                        ①小計（${billingInfo.lessonCount}回）
                                    </td>
                                    <td style="padding: 8px 4px; text-align: right; font-weight: bold; color: #111;">
                                        ${formatCurrency(billingInfo.lessonFeeTotal + billingInfo.transportFeeTotal)}
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                        ...
                        <table style="width: 100%; font-size: 14px; border-collapse: collapse;">
                            ...
                            <tfoot>
                                <tr style="border-top: 2px solid #ddd;">
                                    ...
                                    <td style="padding: 8px 4px; text-align: right; font-weight: bold; color: ${billingInfo.adjustments.total < 0 ? '#16a34a' : '#111'};">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        ...
                        <div>
                            ...
                            <table style={{ width: '100%', fontSize: '14px', borderCollapse: 'collapse' }}>
                                ...
                                <tbody>
                                    {billingInfo.adjustments.details.length > 0 ? (
                                ...
                                <tfoot>
                                    <tr style={{ borderTop: '2px solid #ddd' }}>
                                        ...
                                        <td style={{
                                            ...
                                            textAlign: 'right',
                                            fontWeight: 'bold',
                                            color: billingInfo.adjustments.total < 0 ? '#16a34a' : '#111'
                                        }}>
                                            {billingInfo.adjustments.total > 0 ? '+' : ''}{formatCurrency(billingInfo.adjustments.total)}
                                        </td>
                                    </tr>
                        ...
                        {/* Section 3: Other Charges */}
                        {billingInfo.otherCharges && billingInfo.otherCharges.items.length > 0 && (
                            <div>
                                <h3 style={{
                                    fontSize: '14px',
                                    fontWeight: 'bold',
                    ...
                    <div style={{ marginTop: '32px', paddingTop: '16px', borderTop: '2px solid #111' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ fontSize: '18px', fontWeight: 'bold', color: '#111' }}>
                                合計金額（①+②{billingInfo.otherCharges && billingInfo.otherCharges.items.length > 0 ? '+③' : ''}）
                            </span>
                            <span style={{ fontSize: '24px', fontWeight: 'bold', color: '#111' }}>
                                {formatCurrency(billingInfo.totalAmount)}
                            </span>
